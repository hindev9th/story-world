...
@section('content')
    ...
    <div class="content pt-5">
        ...
        <div class="card shadow-none border border-300 mb-3" id="tableExample1" data-list='{"valueNames":["stt","id","name"],"page":5,"pagination":true}'>
            <div class="card-header p-4 border-bottom border-300 bg-soft">
                <div class="row g-3 justify-content-between align-items-center">
                    ...
                    <div class="col col-md-auto">
                        <a href="{{ route('admin.tag.create') }}" class="btn btn-phoenix-success btn-sm " type="button"><span class="fa fa-plus"></span><span class="ms-1">New</span></a>
                    </div>
                </div>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="action" style="width: 50px">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="{{ route('admin.tag.edit',['tag' => $tag->name]) }}">Edit</a>
{{--                                                <div class="dropdown-divider">--}}
{{--                                                </div>--}}
                                                <a class="dropdown-item text-danger" href="#!" onclick="event.preventDefault();document.getElementById('{{'form-delete-'.$tag->id}}').submit();">Remove</a>
                                            </div>
                                        </td>
                                        <form action="{{ route('admin.tag.destroy',['tag' => $tag->name]) }}" id="{{'form-delete-'.$tag->id}}" method="post">
                                            @method('DELETE')
                                            @csrf
                                        </form>
                                    </tr>
                        ...
                        <div class="row align-items-center mt-3">
                            ...
                            <div class="col">
                                <p class="mb-0 fs--1">
                                    <span class="d-none d-sm-inline-block" data-list-info="">1 to 5 <span
                                            class="text-600"> Items of </span> 15</span>
